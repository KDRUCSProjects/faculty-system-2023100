...
export default function SelectStudentItem(props) {
   return (
      <TouchableOpacity
         style={props.studentId == props.selected ? styles.selected : styles.container}
         ...
         >
            ...
            <View style={{ justifyContent: 'flex-start', width: '70%' }}>
               <Text
                  numberOfLines={2}
                  ellipsizeMode='tail'
                  style={props.studentId == props.selected ? styles.selectedText : styles.text}
               >
                  {props.studentName}
               </Text>
               <Text style={props.studentId == props.selected ? styles.selectedText : styles.text}>
